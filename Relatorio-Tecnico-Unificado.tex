...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{{"Trabalho 1 Sistemas de Controle/Imagens/CAFxUxCB"}.png}
  \caption{Concentração de equilíbrio de \( C_b \) variando u(t) e \( C_{af} \).}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{{"Trabalho 2 Sistemas de Controle/Imagens/1B/1BComparacaoPILR"}.png}
