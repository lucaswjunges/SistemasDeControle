...
\begin{frame}{Parte II: A Solução Inteligente (LR + Feedforward)}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \includegraphics[width=0.25\textwidth]{"Trabalho 2 Sistemas de Controle/image3".png}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \includegraphics[width=0.25\textwidth]{"Trabalho 2 Sistemas de Controle/image2".png}
            \end{figure}
        \end{column}
    \end{columns}
